	...
	local options = {
		...
		args = {
			header = {
				order = 1,
				type = "header",
				name = L["NihilistUI ToyBar by Nihilistzsche"]
			},
			description = {
				order = 2,
				type = "description",
				name = L["NihilistUI ToyBar provides an automatically updated bar populated with your favorite toys."]
			},
			general = {
				order = 3,
				type = "group",
				...
				guiInline = true,
				get = function(info)
					return E.db.nihilistui.utilitybars.toybar[info[#info]]
				end,
				set = function(info, value)
					E.db.nihilistui.utilitybars.toybar[info[#info]] = value
				...
				args = {
					...
					resetsettings = {
						...
						func = function()
							E:CopyTable(E.db.nihilistui.utilitybars.toybar, P.nihilistui.utilitybars.toybar)
							self:UpdateBar(self.bar)
						end
					},
					mouseover = {

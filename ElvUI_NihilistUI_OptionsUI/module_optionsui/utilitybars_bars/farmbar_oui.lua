	...
	local options = {
		...
		args = {
			header = {
				order = 1,
				type = "header",
				name = L["NihilistUI FarmBar by Nihilistzsche, based on work by Azilroka"]
			},
			description = {
				order = 2,
				type = "description",
				name = L["NihilistUI FarmBar provides a bar to manually track items and currencies you are farming."]
			},
			general = {
				order = 3,
				type = "group",
				...
				guiInline = true,
				get = function(info)
					return E.db.nihilistui.utilitybars.farmBar[info[#info]]
				end,
				set = function(info, value)
					E.db.nihilistui.utilitybars.farmBar[info[#info]] = value
				...
				args = {
					...
					resetsettings = {
						...
						func = function()
							E:CopyTable(E.db.nihilistui.utilitybars.farmBar, P.nihilistui.utilitybars.farmBar)
							self:UpdateBar(self.bar)
						end
					},
					mouseover = {

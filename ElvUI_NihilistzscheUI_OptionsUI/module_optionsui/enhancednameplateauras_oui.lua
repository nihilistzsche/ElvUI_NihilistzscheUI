...
local function UpdateSpellGroup()
  if not selectedSpellID or not E.global.nameplates.spellList[selectedSpellID] then
    E.Options.args.NihilistzscheUI.args.modules.args.EnhancedNameplateAuras.args.specificSpells.args.spellGroup = nil
    return
  end
  ...
  E.Options.args.NihilistzscheUI.args.modules.args.EnhancedNameplateAuras.args.specificSpells.args.spellGroup = {
    ...
    order = -10,
    get = function(info)
      return E.global.nameplates.spellList[selectedSpellID][info[#info]]
    end,
    ...
    args = {
      visibility = {
        ...
        get = function()
          return E.global.nameplates.spellList[selectedSpellID].visibility
        end,
        set = function(_, value)
          E.global.nameplates.spellList[selectedSpellID].visibility = value
        end
      },
      width = {
        type = "range",
        ...
        step = 2,
        get = function()
          return E.global.nameplates.spellList[selectedSpellID].width
        end,
        set = function(_, value)
      ...
      height = {
        ...
        disabled = function()
          return E.global.nameplates.spellList[selectedSpellID].lockAspect
        end,
        min = 10,
        max = 100,
        step = 2,
        get = function()
          return E.global.nameplates.spellList[selectedSpellID].height
        end,
        set = function(_, value)
          E.global.nameplates.spellList[selectedSpellID].height = value
        end
      ...
      lockAspect = {
        ...
        set = function(_, value)
          ...
          if value then
            E.global.nameplates.spellList[selectedSpellID].height = E.global.nameplates.spellList[selectedSpellID].width
          end
        end
      },
      stackSize = {
        ...
        step = 1,
        get = function()
          return E.global.nameplates.spellListDefault.stackSize
        end,
        set = function(_, value)
          E.global.nameplates.spellListDefault.stackSize = value
        end
      },
      text = {
        type = "range",
        ...
        step = 1,
        get = function()
          return E.global.nameplates.spellList[selectedSpellID].text
        end,
        set = function(_, value)
          E.global.nameplates.spellList[selectedSpellID].text = value
        end
      }
    }
  }
  ...
  local options = {
    ...
    args = {
      ...
      otherSpells = {
        ...
        args = {
          ...
          visibility = {
            ...
            values = {[1] = "Always", [2] = "Never", [3] = "Only Mine"},
            get = function()
              return E.global.nameplates.spellListDefault.visibility
            end,
            set = function(_, value)
              E.global.nameplates.spellListDefault.visibility = value
            end
          },
          width = {
            type = "range",
            ...
            step = 2,
            get = function()
              return E.global.nameplates.spellListDefault.width
            end,
            set = function(_, value)
          ...
          height = {
            ...
            desc = L["Set the height of this spells icon."],
            disabled = function()
              return E.global.nameplates.spellListDefault.lockAspect
            end,
            min = 10,
            max = 100,
            step = 2,
            get = function()
              return E.global.nameplates.spellListDefault.height
            end,
            set = function(_, value)
              E.global.nameplates.spellListDefault.height = value
            end
          ...
          text = {
            ...
            step = 1,
            get = function()
              return E.global.nameplates.spellListDefault.text
            end,
            set = function(_, value)
              E.global.nameplates.spellListDefault.text = value
            end
          }
        }
      },
      ccDebuffCasterInfo = {
        ...
        get = function(info)
          return E.db.nihilistzscheui.enhancednameplateauras.ccDebuffCasterInfo[info[#info]]
        end,
        set = function(info, value)

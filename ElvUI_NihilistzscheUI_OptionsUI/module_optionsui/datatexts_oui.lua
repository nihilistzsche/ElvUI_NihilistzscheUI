...
function ISD.GenerateOptions()
  ...
  local options = {
    ...
    get = function(info)
      return E.db.nihilistzscheui.sysdt[info[#info]]
    end,
    ...
    args = {
      ...
      latency = {
        ...
        disabled = function()
          return not E.db.nihilistzscheui.sysdt.showMS
        end,
        values = {
          home = L.Home,
          world = L.World
...
function PDT.GenerateOptions()
  local options = {
    ...
    get = function(info)
      return E.db.nihilistzscheui.profdt[info[#info]]
    end,
    set = function(info, value)
...
function TDT.GenerateOptions()
  local options = {
    ...
    get = function(info)
      return E.db.nihilistzscheui.titlesdt[info[#info]]
    end,
    set = function(info, value)

  ...
  local options = {
    ...
    args = {
      ...
      general = {
        ...
        guiInline = true,
        get = function(info)
          return E.db.nihilistzscheui.hiddenArtifactTracker[info[#info]]
        end,
        ...
        args = {
          ...
          resetsettings = {
            ...
            func = function()
              ...
              E:CopyTable(E.db.nihilistzscheui.hiddenArtifactTracker, P.nihilistzscheui.hiddenArtifactTracker)

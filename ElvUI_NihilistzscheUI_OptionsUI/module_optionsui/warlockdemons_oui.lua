...
function WD:GenerateOptions()
  ...
  if self.styleFilterHooked then
    ...
    E.Options.args.nameplates.args.filters.args.selectFilter.set = function(info, value)
      ...
      -- luacheck: push  no max line length
      if
        not E.Options.args.nameplates.args.filters.args.triggers.args.combat.args.demonologyWarlockDemonAboutToExpireNUI
       then
        E.Options.args.nameplates.args.filters.args.triggers.args.combat.args.isDemonologyWarlockDemonNUI = {
        ...
        E.Options.args.nameplates.args.filters.args.triggers.args.combat.args.isNotDemonologyWarlockDemonNUI = {
        ...
        E.Options.args.nameplates.args.filters.args.triggers.args.combat.args.demonologyWarlockDemonAboutToExpireNUI = {

...
function DBN.GenerateOptions()
  local options = {
    ...
    get = function(info)
      return E.db.nihilistzscheui.databarnotifier[info[#info]]
    end,
    ...
    args = {
      ...
      description = {
        ...
        type = "description",
        name = L[
          "NihilistzscheUI DataBarNotifier prints out messages to a given chat frame when you gain experience, reputation, artifact xp, or honor.\n"
        ]
      },
      general = {
        order = 3,

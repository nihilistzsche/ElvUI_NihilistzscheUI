  ...
  local options = {
    ...
    args = {
      ...
      general = {
        ...
        guiInline = true,
        get = function(info)
          return E.db.nihilistzscheui.utilitybars.specSwitchBar[info[#info]]
        end,
        ...
        args = {
          ...
          resetsettings = {
            ...
            func = function()
              E:CopyTable(E.db.nihilistzscheui.utilitybars.specSwitchBar, P.nihilistzscheui.utilitybars.specSwitchBar)
              self:UpdateBar(self.bar)
            end
          },
          mouseover = {

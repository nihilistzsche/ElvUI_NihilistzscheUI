  ...
  local options = {
    ...
    args = {
      ...
      description = {
        ...
        type = "description",
        name = L[
          "NihilistzscheUI EngineerToyBar provides an automatically updated bar populated with your engineering toys."
        ]
      },
      general = {
        order = 3,
        ...
        guiInline = true,
        get = function(info)
          return E.db.nihilistzscheui.utilitybars.engineertoybar[info[#info]]
        end,
        ...
        args = {
          ...
          resetsettings = {
            ...
            func = function()
              E:CopyTable(E.db.nihilistzscheui.utilitybars.engineertoybar, P.nihilistzscheui.utilitybars.engineertoybar)
              self:UpdateBar(self.bar)
            end
          },
          mouseover = {

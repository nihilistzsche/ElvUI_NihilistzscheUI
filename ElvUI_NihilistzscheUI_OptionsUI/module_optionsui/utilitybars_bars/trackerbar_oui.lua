    ...
    local options = {
        ...
        args = {
            header = {
                order = 1,
                type = "header",
                name = L["NihilistzscheUI TrackerBar by Nihilistzsche, based on work by Azilroka"],
            },
            description = {
                order = 2,
                type = "description",
                name = L["NihilistzscheUI TrackerBar provides a bar to manually track items and currencies you are farming."],
            },
            general = {
                order = 3,
                type = "group",
                name = "General",
                guiInline = true,
                get = function(info) return E.db.nihilistzscheui.utilitybars.trackerbar[info[#info]] end,
                set = function(info, value)
                    E.db.nihilistzscheui.utilitybars.trackerbar[info[#info]] = value
                ...
                args = {
                    ...
                    resetsettings = {
                        ...
                        func = function()
                            E:CopyTable(
                                E.db.nihilistzscheui.utilitybars.trackerbar,
                                P.nihilistzscheui.utilitybars.trackerbar
                            )
                            self:UpdateBar(self.bar)
                        end,
                    },

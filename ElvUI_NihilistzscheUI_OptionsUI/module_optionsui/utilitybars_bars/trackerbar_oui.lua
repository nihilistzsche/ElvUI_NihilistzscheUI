  ...
  local options = {
    ...
    args = {
      ...
      general = {
        ...
        guiInline = true,
        get = function(info)
          return E.db.nihilistzscheui.utilitybars.trackerbar[info[#info]]
        end,
        ...
        args = {
          ...
          resetsettings = {
            ...
            func = function()
              E:CopyTable(E.db.nihilistzscheui.utilitybars.trackerbar, P.nihilistzscheui.utilitybars.trackerbar)
              self:UpdateBar(self.bar)
            end
          },
          mouseover = {

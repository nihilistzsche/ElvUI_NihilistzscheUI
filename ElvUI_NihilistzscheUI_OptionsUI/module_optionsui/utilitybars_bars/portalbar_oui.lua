  ...
  local options = {
    ...
    args = {
      ...
      general = {
        ...
        guiInline = true,
        get = function(info)
          return E.db.nihilistzscheui.utilitybars.portalBar[info[#info]]
        end,
        ...
        args = {
          ...
          resetsettings = {
            ...
            func = function()
              E:CopyTable(E.db.nihilistzscheui.utilitybars.portalBar, P.nihilistzscheui.utilitybars.portalBar)
              self:UpdateBar(self.bar)
            end
          },
          mouseover = {

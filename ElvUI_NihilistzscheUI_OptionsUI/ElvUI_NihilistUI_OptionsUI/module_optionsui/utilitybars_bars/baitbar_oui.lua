	...
	local options = {
		...
		args = {
			header = {
				order = 1,
				type = "header",
				name = L["NihilistUI BaitBar by Infinitron, based on work by Azilroka"]
			},
			description = {
				order = 2,
				type = "description",
				name = L["NihilistUI BaitBar provides a bar to use fishing baits from."]
			},
			general = {
				order = 3,
				type = "group",
				...
				guiInline = true,
				get = function(info)
					return E.db.nihilistui.utilitybars.baitBar[info[#info]]
				end,
				set = function(info, value)
					E.db.nihilistui.utilitybars.baitBar[info[#info]] = value
				...
				args = {
					...
					resetsettings = {
						...
						func = function()
							E:CopyTable(E.db.nihilistui.utilitybars.baitBar, P.nihilistui.utilitybars.baitBar)
							self:UpdateBar(self.bar)
						end
					},
					mouseover = {

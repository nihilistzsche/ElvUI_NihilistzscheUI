	...
	local options = {
		...
		args = {
			header = {
				order = 1,
				type = "header",
				name = L["NihilistUI RaidPrepBar by Nihilistzsche, based on work by Azilroka"]
			},
			description = {
				order = 2,
				type = "description",
				name = L["NihilistUI RaidPrepBar provides a bar for your flasks and food."]
			},
			general = {
				order = 3,
				type = "group",
				...
				guiInline = true,
				get = function(info)
					return E.db.nihilistui.utilitybars.raidPrepBar[info[#info]]
				end,
				set = function(info, value)
					E.db.nihilistui.utilitybars.raidPrepBar[info[#info]] = value
				...
				args = {
					...
					resetsettings = {
						...
						func = function()
							E:CopyTable(E.db.nihilistui.utilitybars.raidPrepBar, P.nihilistui.utilitybars.raidPrepBar)
							self:UpdateBar(self.bar)
						end
					},
					mouseover = {

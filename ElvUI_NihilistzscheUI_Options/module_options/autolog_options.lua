...
function AL:GenerateOptions()
    local options = {
        type = "group",
        name = "AutoLog",
        get = function(info) return E.db.nihilistzscheui.autolog[info[#info]] end,
        set = function(info, value) E.db.nihilistzscheui.autolog[info[#info]] = value end,
        args = {
            name = {
                order = 1,
                type = "header",
            ...
            enabled = {
                ...
                set = function(info, value)
                    E.db.nihilistzscheui.autolog[info[#info]] = value
                    self:UpdateEnabled()
                end,
            },
            spacer1 = {

            ...
            items = {
                ...
                args = {
                    id = {
                        ...
                        type = "input",
                        get = function() return itemLink or "" end,
                    ...
                    target = {
                        ...
                        name = "Target",
                        type = "input",
                        get = function() return itemTarget or "" end,
                        set = function(_, value)
                            itemTarget = value
                            self:UpdateWatchOptions(options)
                        end,
                    ...
                    addwatch = {
                        ...
                        type = "execute",
                        name = "Add Item Watch",
                        disabled = function() return not self.GetID(itemID, true) or not tonumber(itemTarget) end,
                        func = function()
            ...
            currency = {
                ...
                args = {
                    id = {
                        ...
                        type = "input",
                        get = function() return currencyLink or "" end,
                        set = function(_, value)
                            currencyLink = value
                    ...
                    target = {
                        ...
                        name = "Target",
                        type = "input",
                        get = function() return currencyTarget or "" end,
                        set = function(_, value)
                    ...
                    addwatch = {
                        ...
                        type = "execute",
                        name = "Add Currency Watch",
                        disabled = function() return not FB:GetID(currencyID, false) or not tonumber(currencyTarget) end,
                        func = function()
    ...
    local options = {
        ...
        args = {
            ...
            general = {
                ...
                name = "General",
                guiInline = true,
                get = function(info) return E.db.nihilistzscheui.utilitybars.farmBar[info[#info]] end,

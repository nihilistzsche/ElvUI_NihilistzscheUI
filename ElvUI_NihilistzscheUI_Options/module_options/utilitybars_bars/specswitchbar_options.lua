    ...
    local options = {
        ...
        args = {
            header = {
                order = 1,
                type = "header",
                name = L["NihilistzscheUI SpecSwitchBar by Nihilistzsche"],
            },
            description = {
                order = 2,
                type = "description",
                name = L["NihilistzscheUI SpecSwitchBar provides a bar to change your spec and loot spec."],
            },
            general = {
                order = 3,
                type = "group",
                name = "General",
                guiInline = true,
                get = function(info) return E.db.nihilistzscheui.utilitybars.specSwitchBar[info[#info]] end,
                set = function(info, value)
                    E.db.nihilistzscheui.utilitybars.specSwitchBar[info[#info]] = value
                ...
                args = {
                    ...
                    resetsettings = {
                        ...
                        func = function()
                            E:CopyTable(
                                E.db.nihilistzscheui.utilitybars.specSwitchBar,
                                P.nihilistzscheui.utilitybars.specSwitchBar
                            )
                            self:UpdateBar(self.bar)
                        end,
                    },

    ...
    local options = {
        ...
        args = {
            ...
            general = {
                ...
                name = "General",
                guiInline = true,
                get = function(info) return E.db.nihilistzscheui.utilitybars.raidPrepBar[info[#info]] end,
                ...
                args = {
                    ...
                    resetsettings = {
                        ...
                        func = function()
                            E:CopyTable(
                                E.db.nihilistzscheui.utilitybars.raidPrepBar,
                                P.nihilistzscheui.utilitybars.raidPrepBar
                            )
                            self:UpdateBar(self.bar)
                        end,
                    },

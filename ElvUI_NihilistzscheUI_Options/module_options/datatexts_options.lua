...
function ISD.GenerateOptions()
    ...
    local options = {
        ...
        get = function(info) return E.db.nihilistzscheui.sysdt[info[#info]] end,
        set = function(info, value)
            E.db.nihilistzscheui.sysdt[info[#info]] = value
            DT:LoadDataTexts()
        end,
        args = {
            maxAddons = {
            ...
            latency = {
                ...
                disabled = function() return not E.db.nihilistzscheui.sysdt.showMS end,
                values = {
                    home = L.Home,
                    world = L.World,
                },
...
function PDT.GenerateOptions()
    local options = {
        ...
        get = function(info) return E.db.nihilistzscheui.profdt[info[#info]] end,
        set = function(info, value)
            E.db.nihilistzscheui.profdt[info[#info]] = value
            DT:LoadDataTexts()
        end,
        args = {
            prof = {
...
function TDT.GenerateOptions()
    local options = {
        ...
        get = function(info) return E.db.nihilistzscheui.titlesdt[info[#info]] end,
        set = function(info, value)
            E.db.nihilistzscheui.titlesdt[info[#info]] = value
            DT:LoadDataTexts()
        end,
        args = {
            useName = {

...
function NC:MinimizeAllChats()
    ...
    for _, v in ipairs(self.chats) do
        if self.MinimizeAll then
            if not v.minimized then self:SetMinimized(v) end
        else
            self:SetMaximized(v)
        end
    end
    if self.MinimizeAll then
        ...
        E.Options.args.NihilistzscheUI.args.modules.args.NihilistzscheChat.args.general.args.minimizeall.name =
            L.Maximize
    else
    ...
    local options = {
        ...
        args = {
            ...
            general = {
                ...
                name = L.General,
                guiInline = true,
                get = function(info) return E.db.nihilistzscheui.nihilistzschechat.general[info[#info]] end,
                ...
                args = {
                    ...
                    minimizeall = {
                        ...
                        name = L.Minimize,
                        order = 3,
                        func = function() NC:MinimizeAllChats() end,
                    },
                    bordercolor = {
                        type = "color",
                        order = 4,
            ...
            windows = {
                ...
                name = L.Options,
                guiInline = true,
                get = function(info) return E.db.nihilistzscheui.nihilistzschechat.windows[info[#info]] end,
                set = function(info, value)

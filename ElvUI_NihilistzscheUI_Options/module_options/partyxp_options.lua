    ...
    local options = {
        ...
        args = {
            header = {
                order = 1,
                type = "header",
                name = L["NihilistzscheUI PartyXP by Nihilistzsche"],
            },
            description = {
                order = 2,
                type = "description",
                name = L["NihilistzscheUI PartyXP provides a configurable set of party experience bars for use with ElvUI.\n"],
            },
            general = {
                order = 3,
                type = "group",
                ...
                args = {
                    ...
                    resetsettings = {
                        ...
                        func = function()
                            E:CopyTable(self.db, P.nihilistzscheui.pxp)
                            self:Enable()
                            self:Update()
                            self:UpdateMedia()
            ...
            partyXpOptions = {
                ...
                args = {
                    ...
                    color = {
                        ...
                        name = "Bar Color",
                        hasAlpha = false,
                        disabled = function() return not self.db.classColor end,
                        get = function(info)
                    ...
                    tag = {
                        ...
                        order = 9,
                        get = function() return self.db.tag end,

...
local nihilistui_chat_icon = [[|TInterface\AddOns\ElvUI_NihilistUI\media\textures\nihilistui_text_logo:12:12|t]]
...
function NUI.ClickGameMenu()
	...
	E:ToggleOptionsUI()
	ACD:SelectGroup("ElvUI", "NihilisttUI")
...
function NUI:BuildGameMenu()
	local button = {
		name = "GameMenu_NihilisttUIConfig",
		text = NUI.Title,
		func = function()
			self.ClickGameMenu()
		end

...
function TOTTB.AddTools()
	...
	PT:AddData(
		"NihilistUI.ToolsOfTheTrade",
		"Rev: 1",
		{
			["NihilistUI.ToolsOfTheTrade"] = "156631,152839,164766,153670,153716,154170,164733,164740"
		}
	)
end
...
function TOTTB:UpdateBar(bar)
	...
	if (inToolZone) then
		local db = PT:GetSetTable("NihilistUI.ToolsOfTheTrade")
...
function TOTTB:Initialize()
	self.AddTools()
	local frame = CreateFrame("Frame", "NihilistUI_ToolsOfTheTradeController")

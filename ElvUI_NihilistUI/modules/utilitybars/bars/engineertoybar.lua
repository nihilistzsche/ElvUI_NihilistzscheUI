...
function ETOYB.CreateBar()
	...
	local bar =
		NUB:CreateBar("NihilistUI_EngineerToyBar", "engineertoybar", {"BOTTOMRIGHT", _G.RightChatPanel, "TOPRIGHT", 0, 65}, "Engineer Toy Bar")
...
function ETOYB:Initialize()
	local frame = CreateFrame("Frame", "NihilistUI_EngineerToyBarController")

...
function VUF:PostUpdateHealth(unit, min, max)
	...
	if (min / max * 100) < (E.db.nihilistui.vuf.lowThreshold) then
		E:Flash(parent, 0.6)
		if (not warningTextShown and unit == "player") and E.db.nihilistui.vuf.warningText then
		...
		if unit == "player" and E.db.nihilistui.vuf.screenflash then

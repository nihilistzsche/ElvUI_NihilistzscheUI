...
function PBN:CheckFriendlyNPCNameVisibility(event)
	...
	elseif
		(not self.oldFriendlyNPCVisibility or not self.oldNameplateOccludedAlphaMult) and event == "PET_BATTLE_OPENING_START"
	 then
...
function PBN:Initialize()
	...
	self.db = E.db.nihilistui.petbattlenameplates

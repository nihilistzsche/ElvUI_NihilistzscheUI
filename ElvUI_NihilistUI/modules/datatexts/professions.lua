...
local function OnEvent(self)
	...
	if E.db.nihilistui.profdt.prof == "prof1" then
		if prof1 ~= nil then
	...
	elseif E.db.nihilistui.profdt.prof == "prof2" then
		if prof2 ~= nil then
	...
	elseif E.db.nihilistui.profdt.prof == "archy" then
		if archy ~= nil then
	...
	elseif E.db.nihilistui.profdt.prof == "fishing" then
		if fishing ~= nil then
	...
	elseif E.db.nihilistui.profdt.prof == "cooking" then
		if cooking ~= nil then
...
local function OnEnter(self)
	...
	if E.db.nihilistui.profdt.hint then
		DT.tooltip:AddLine(" ")

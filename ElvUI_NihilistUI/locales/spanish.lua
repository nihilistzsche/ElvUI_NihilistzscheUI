...
L["NIHILISTUI_AUTHOR_INFO"] = "|cffff2020NihilistUI|r by Nihilistzsche"
L["NIHILISTUI_CONTACTS"] = [=[Report issues at https://git.tukui.org/Nihilistzsche/ElvUI_NihilistUI/issues]=]

-- Bait Bar
L["Bait Bar"] = true
L["NihilistUI BaitBar by Nihilistzsche, based on work by Azilroka"] = true
L["NihilistUI BaitBar provides a bar to use fishing baits from."] = true
L["Enable the bait bar"] = true
L["Only show the bait bar when you mouseover it"] = true

-- ButtonStyle
L["ButtonStyle"] = true
L["NihilistUI ButtonStyle by Nihilistzsche"] = true
L["NihilistUI ButtonStyle provides a style setting for ElvUI buttons similar to Masque or ButtonFacade\n"] = true
L["Enable the button style."] = true

-- WatchBarNotifier
L["WatchBarNotifier"] = true
L["NihilistUI WatchBarNotifier by Nihilistzsche"] = true
L[
		"NihilistUI WatchBarNotifier prints out messages to a given chat frame when you gain experience, reputation, artifact xp, or honor.\n"
	] = true
...
L["Farm Bar"] = true
L["NihilistUI FarmBar by Nihilistzsche, based on work by Azilroka"] = true
L["NihilistUI FarmBar provides a bar to manually track items and currencies you are farming."] = true
...
L["Minimize"] = true
L["NihilistChat"] = true
L["NihilistChat by Nihilistzsche/Hydrazine (tukui.org)"] = true
L["NihilistChat makes your chat experience awesome"] = true
L["Border Color"] = true
...
L["NihilistUI ObjectiveTrackerHider by Nihilistzsche"] = true
L["NihilistUI ObjectiveTrackerHider hides or collapses the objective tracker based on your configuration."] = true
...
-- PartyXP
L["PartyXP"] = true
L["NihilistUI PartyXP by Nihilistzsche"] = true
L["NihilistUI PartyXP provides a configurable set of party experience bars for use with ElvUI.\n"] = true
...
-- Portal Bar
L["Portal Bar"] = true
L["NihilistUI PortalBar by Nihilistzsche, based on work by Azilroka"] = true
L["NihilistUI PortalBar provides a bar for mage portals and mage and challenge mode teleports."] = true
...
L["NihilistUI ProfessionBar by Nihilistzsche, based on work by Azilroka"] = true
L["NihilistUI ProfessionBar provides an automatically updated bar with profession skills."] = true
...
L["NihilistUI RaidPrepBar by Nihilistzsche, based on work by Azilroka"] = true
L["NihilistUI RaidPrepBar provides a bar for your flasks and food."] = true
...
-- VerticalUnitFrames
L["NihilistUI VerticalUnitFrames "] = true
...
L["NihilistUI VerticalUnitFrames by Nihilistzsche"] = true
L["NihilistUI VerticalUnitFrames provides a configurable centered, vertical unit frame option for use with ElvUI.\n"] =
	true
L["Reset the settings of this addon to their defaults."] = true
...
L["Value"] = true
L["Default"] = true
L["NihilistUI_VerticalUnitFrames_CREDITS"] =
...
L["Thank you for using NihilistUI VerticalUnitFrames!"] = true
L[
...
L["NihilistUI Equipment Manager by Nihilistzsche, based on work by Azilroka"] = true
L["NihilistUI Equipment Manager provides a bar for managing your equipment sets."] = true
L["General"] = true
L["Enable"] = true
...
L["CooldownBar"] = true
L["NihilistUI CooldownBar by Nihilistzsche"] = true
L["NihilistUI CooldownBar provides a logarithmic cooldown display similar to SexyCooldown2\n"] = true
...
L["%sElvUI|r NihilistUI - Mounts Datatext"] = true
...
L["%sElvUI|r NihilistUI - Companions Datatext"] = true
...
L["NihilistUI ArtifactPowerButton by Nihilistzsche"] = true
L["NihilistUI ArtifactPowerButton provides a button for you to consume your artifact power items in your bags."] = true
...
L["Attempted to show a reminder icon that does not have any spells. You must add a spell first."] =
	"Se ha intentado añadir un icono recordatorio sin ningún hechizo. Añade un hechizo primero."
L["Caster"] = "Lanzador"
...
L[
	...
	"Cambia esto si quieres que el módulo recordatorio compruebe encantamientos de arma, esto hará que se ignoren hechizos listados."
L["Combat"] = "Combate"
...
L["If any spell found inside this list is found the icon will hide as well"] =
	"Si se detecta cualquier hechizo dentro de esta lista, se ocultará el icono."
...
L["Instead of hiding the frame when you have the buff, show the frame when you have the buff."] =
	"En vez de ocultar el marco cuando tienes el beneficio, se mostrará cuando lo tengas."
L["Level Requirement"] = "Nivel requerido"
L["Level requirement for the icon to be able to display. 0 for disabled."] =
	"Nivel requerido para que se muestre el icono. Ajustar a 0 para desactivar."
...
L["REMINDER_DESC"] =
	"Este módulo mostrará iconos de aviso en tu pantalla cuando te falten beneficios o tengas alguno que no deberías."
...
L["Set a talent tree to not follow the reverse check."] =
	"Ajustar un árbol de talentos para que no se ajuste a la comprobación invertida."
L["Sound"] = "Sonido"
L["Sound that will play when you have a warning icon displayed."] =
	"El sonido que se reproducirá cuando se muestre un icono de aviso."
L["Spell"] = "Hechizo"
L["Spells"] = "Hechizos"
...
L[
	...
	"Esta opción se asegura que solo veas hechizos que hayas aprendido. Puede que quieras desactivar esta opción si estás intentando monitorizar un hechizo que no sea usable desde tu libro de hechizos."
L["Tree Exception"] = "Árbol Excluido"
L["Weapon"] = "Arma"
L["You can't remove a default group from the list, disabling the group."] =
	"No puedes borrar un grupo predeterminado de la lista. El grupo se ha desactivado."
L["You must be a certain role for the icon to appear."] =
	"Debes pertenecer a un rol específico para que se muestre el icono."
L["You must be using a certain talent tree for the icon to show."] =
	"Debes estar usando un árbol de talentos específico para que se muestre el icono."

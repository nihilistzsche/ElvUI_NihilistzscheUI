...
L["NIHILISTUI_AUTHOR_INFO"] =
	"|cffff2020NihilistUI|r by Nihilistzsche"

L["NIHILISTUI_CONTACTS"] =
	[=[Report issues at |cFF00c0fa[|Hurl:https://git.tukui.org/Nihilistzsche/ElvUI_NihilistUI/issues|hhttps://git.tukui.org/Nihilistzsche/ElvUI_NihilistUI/issues|h]|r]=]
...
L["If any spell found inside this list is found the icon will hide as well"] =
	"If any spell found inside this list is found the icon will hide as well"
...
L["Level requirement for the icon to be able to display. 0 for disabled."] =
	"Level requirement for the icon to be able to display. 0 for disabled."
...
L["REMINDER_DESC"] =
	"This module will show warning icons on your screen when you are missing buffs or have buffs when you shouldn't."
...
L["Sound that will play when you have a warning icon displayed."] =
	"Sound that will play when you have a warning icon displayed."
L["Spell"] = "Spell"
...
L["You can't remove a default group from the list, disabling the group."] =
	"You can't remove a default group from the list, disabling the group."
...
L["You must be using a certain talent tree for the icon to show."] =
	"You must be using a certain talent tree for the icon to show."
L["CD Fade"] = true
L["Cooldown"] = true
L["On Cooldown"] = true
L["Reminders"] = true

---@class NUI
local NUI, E, L, _, P, _ = _G.unpack((select(2, ...)))
...
function PBN:GenerateOptions()
    ...
    local options = {
        ...
        get = function(info) return E.db.nihilistzscheui.petbattlenameplates[info[#info]] end,
        set = function(info, value) E.db.nihilistzscheui.petbattlenameplates[info[#info]] = value end,
        args = {
            header = {
                order = 1,
                type = "header",
            ...
            showBreedID = {
                ...
                disabled = function() return not BattlePetBreedID or not self.db.enabled end,
            },
        },
    }
    return options

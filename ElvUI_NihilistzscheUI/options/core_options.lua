...
local NO = NUI.Options
local COMP = NUI.Compatibility

local format = _G.format
local tinsert = _G.tinsert

function NO.GenerateModuleList()
    local list = ""
...
function NO.GenerateInstalledAddOnList()
    local list = ""
    local addons = {}
...
- more customization options for existing ones.]=],
            ...
            addons = {
                ...
                args = {
                    ...
                    description = {
                        order = 2,
                        type = "description",
                        name = NO:GenerateInstalledAddOnList(),
                    },
                },
            },
        },
    ...
    for _, m in pairs(NUI:GetRegisteredModules()) do
        ...
        if mod ~= NO and mod.GenerateOptions then mods[mod:GetName()] = mod end
    end
    local order = 1

...
function SASX.SkinKalielsTracker()
    if BS and _G["!KalielsTrackerActiveButton"] then BS:StyleButton(_G["!KalielsTrackerActiveButton"]) end
    _G["!KalielsTrackerFrame"]:CreateBackdrop("Transparent")
    if COMP.BUI then _G["!KalielsTrackerFrame"]:BuiStyle("Outside") end
end

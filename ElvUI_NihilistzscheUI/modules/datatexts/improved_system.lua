...
local ReloadUI = _G.C_UI.ReloadUI
    ...
    if cpuProfiling and not IsShiftKeyDown() then
        ...
        for i = 1, #cpuTable do
            ...
            if cpuTable[i][4] then
                ...
                DT.tooltip:AddDoubleLine(
                    cpuTable[i][2],
                    format(homeLatencyString, cpuTable[i][3]),
                    1,
                    1,
                    1,
                    red,
...
local function Update(self, t)
    ...
    if int2 <= 0 then
        ...
        local latency = select(E.db.nihilistzscheui.sysdt.latency == "world" and 4 or 3, GetNetStats())
...
local function Click(self, button)
    if button == "LeftButton" then
        ...
        if E.db.nihilistzscheui.sysdt.announceFreed then

            ...
            function(_, button)
                if (button == "RightButton") then
                    ...
                    if (frame.type == "item") then
                        message =
                            "|cffff0000Blacklisted|r the cooldown for |cffffff00item|r" .. GetItemInfo(frame.itemID)
                        self.db.blacklist.items[frame.itemID] = true
                    else
                        message =
                            "|cffff0000Blacklisted|r the cooldown for |cffff00ffspell|r" .. GetSpellInfo(frame.spellID)

...
local function DeactivateClosure()
    CB:Deactivate()
end
...
local function RotateClosure()
    CB:RotateOverlapGroups()
end
...
local function UpdateToysClosure()
    CB:UpdateToys()
end

local function UseToyClosure()
    if (CB.db.enabled) then
        C_Timer_After(1.5, UpdateToysClosure)
    end
end

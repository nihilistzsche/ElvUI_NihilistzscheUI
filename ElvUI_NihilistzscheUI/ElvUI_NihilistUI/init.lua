...
NUI.Libs = {
	NT = LibStub("LibNihilistUITags-1.0"),
...
NUI.Version = GetAddOnMetadata("ElvUI_NihilistUI", "Version")
NUI.Title = "|cffff2020NihilistUI|r"
...
NUI.NihilistChat = NUI:NewModule("NihilistChat", "AceEvent-3.0")
NUI.NihilistUIAddOnSkinExtension = NUI:NewModule("NihilistUIAddOnSkinExtension")
NUI.NihilistUIMedia = NUI:NewModule("NihilistUIMedia")
...
NUI.UtilityBars.EquipmentManagerBar = NUI:NewModule("EquipmentManagerBar", "AceHook-3.0", "AceTimer-3.0", "AceEvent-3.0")
...
_G.BINDING_HEADER_NIHILISTUI = "|cffff2020NihilistUI|r"
...
function NUI:RegisterModule(name)
	if self.initialized then
		...
		if (module and module.Initialize) then
			module:Initialize()
			if (ElvUIDev) then
				ElvUIDev:RegisterPluginModule("ElvUI_NihilisttUI", name, module)
			end
		end
	end
...
function NUI:Initialize()
	...
	DB:RegisterCustomQuestXPWatcher("ElvUI_NihilistUI", NUI.CustomQuestXPWatcher)

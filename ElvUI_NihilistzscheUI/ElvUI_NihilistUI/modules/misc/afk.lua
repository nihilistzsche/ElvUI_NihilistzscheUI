...
function NM.HookAFK()
	...
	if (COMP.BUI) then
		...
		SS.bottom.nuilogo:SetTexture("Interface\\AddOns\\ElvUI_NihilistUI\\media\\textures\\elvui_nihilistui_logo.tga")
	...
	elseif SS.bottom.logo then
		SS.bottom.logo:SetTexture("Interface\\AddOns\\ElvUI_NihilistUI\\media\\textures\\elvui_nihilistui_logo.tga")

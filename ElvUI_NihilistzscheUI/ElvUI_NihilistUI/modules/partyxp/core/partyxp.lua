...
function PXP:Update()
	...
	for i, v in ipairs(self.bars) do
		local relative = i == 1 and _G.NihilistUI_PartyXPHolder or self.bars[i - 1]
...
function PXP:CreateBar()
	...
	bar = CreateFrame("StatusBar", nil, _G.NihilistUI_PartyXPHolder, "BackdropTemplate")
	bar:SetSize(_G.NihilistUI_PartyXPHolder:GetSize())
...
function PXP:Initialize()
	...
	local frame = CreateFrame("Frame", "NihilistUI_PartyXPHolder", E.UIParent)
	frame:Size(self.db.width, self.db.height)
	frame:Point("TOP", E.UIParent, "TOP", 0, -50)
	E:CreateMover(frame, "NihilistUI_PartyXPHolderMover", "ElvUI PartyXP Holder", nil, nil, nil, "GENERAL,ALL,NIHILISTUI")

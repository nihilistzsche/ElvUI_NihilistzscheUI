...
function NC:CreateDock()
	local dock = CreateFrame("Frame", "NihilistChatDock", E.UIParent, "BackdropTemplate")
	...
	E:CreateMover(dock, dock:GetName() .. "Mover", "NihilistChat Dock", nil, nil, nil, "ALL,SOLO,NIHILISTUI")
...
NC.TexturePath = "Interface\\AddOns\\ElvUI_NihilistUI\\media\\textures\\"
...
function NC:AddIncoming(event, msg, sender, guid) -- Add messages to the text
	...
	elseif event == "CHAT_MSG_WHISPER" then
		if (self.senderInfo[sender]) then
			str =
				"|Hplayer:" .. sender .. "|h" .. self.senderInfo[sender].classColor .. sender .. "|r|h" .. chat.hex .. ": " .. msg
		else

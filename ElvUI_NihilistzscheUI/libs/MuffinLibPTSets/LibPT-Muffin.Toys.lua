...
LibStub("LibPeriodicTable-3.1"):AddData(
    ...
    "Rev: 12",
    {
        ["Muffin.Toys.Hearth"] = "54452,64488,93672,142542,162973,163045,165669,165670",
        ...
        ["Muffin.Toys.Portal.Other"] = "95567,95568,136849,140324",
        ["Muffin.Toys.Fishing.Misc"] = "85500,85973",
        ["Muffin.Toys.Fishing.Bobbers"] = "142528,142529,142530,142531,142532,143662,147307,147308,147309,147310,147311,147312"
    }
)

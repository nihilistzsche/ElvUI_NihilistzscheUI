...
function MD:AddTextures()
  ...
  self:Register("statusbar", "Simpy Water Paper", [[Interface\AddOns\ElvUI_NihilistzscheUI\media\textures\simpy_tex12]])
  self:Register(
    "statusbar",
    "Simpy Dark Strokes",
  ...
  self:Register("statusbar", "Simpy Crosshatch", [[Interface\AddOns\ElvUI_NihilistzscheUI\media\textures\simpy_tex15]])
  self:Register(
    "statusbar",
    "Simpy Double Dragon",
  ...
  self:Register("statusbar", "Simpy Paw Prints", [[Interface\AddOns\ElvUI_NihilistzscheUI\media\textures\simpy_tex20]])
end
...
function MD:AddFonts()
  ...
  self:Register("font", "BigNoodleTitling", [[Inteface\AddOns\ElvUI_NihilistzscheUI\media\fonts\BigNoodleTitling.ttf]])

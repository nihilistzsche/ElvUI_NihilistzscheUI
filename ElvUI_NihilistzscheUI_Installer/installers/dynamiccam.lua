  ...
  self:SetProfile(
    _G.DynamicCamDB,
    {
      ...
      situations = {
        ...
        ["200"] = {
          executeOnInit = "this.spells = {136508, 189838, 54406, 94719, 556, 168487, 168499, 171253, 50977, 8690, 222695, 171253, 224869, 53140, 3565, 32271, 193759, 3562, 3567, 33690, 35715, 32272, 49358, 176248, 3561, 49359, 3566, 88342, 88344, 3563, 132627, 132621, 176242, 192085, 192084, 216016, 145430};",
          cameraActions = {
            zoomFitToggleNameplate = false,
            zoomMax = 20,
